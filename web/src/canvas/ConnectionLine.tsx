...
export function ConnectionLine({ fromX, fromY, toX, toY, fromNode, fromHandle, connectionStatus }: ConnectionLineComponentProps) {
  ...
  const [d] = getBezierPath({
    sourceX: fromX, sourceY: fromY, sourcePosition: side === "source" ? Position.Right : Position.Left,
    targetX: toX, targetY: toY, targetPosition: side === "source" ? Position.Left : Position.Right,
  });
  return (
